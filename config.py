...
PAGE_URL             = os.environ.get("PAGE_URL",
                          "https://uksgomel.by/centr-prodazh")
BASE_URL             = os.environ.get("BASE_URL",
                          "https://uksgomel.by")
NEWS_PAGE_URL        = os.environ.get("NEWS_PAGE_URL",
                          "https://uksgomel.by/novosti")
NEWS_CHECK_INTERVAL  = int(os.environ.get("NEWS_CHECK_INTERVAL", 60))  # минут
PATTERN              = os.environ.get("PATTERN",
                          r"free_flats_\d{8}\.pdf")
NEWS_LINK_RE         = os.environ.get("NEWS_LINK_RE",
